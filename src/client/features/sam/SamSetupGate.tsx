        ...
        <div className="flex items-start gap-3">
          ...
          <div className="max-w-3xl space-y-1.5">
            ...
            <div className="text-sm text-base-content/68">
              Nion, OpenSEO's in-app AI agent, needs an API key configured.
              Set your <code>MINIMAX_API_KEY</code>, <code>KIMI_API_KEY</code>, or <code>OPENROUTER_API_KEY</code> environment variable, restart
